import type { ModelType } from "./utils/types.ts";
import {
	BoxGeometry,
	BufferAttribute,
	DoubleSide,
...
export class ArmorObject {
	...
	constructor() {
		...
		// boots
		const rightBoot = new BoxGeometry(6, 14.1, 6.1);
